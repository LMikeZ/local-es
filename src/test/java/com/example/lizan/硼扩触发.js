...
try {
    if (newValue == 9) {
        ...
        logger.info("currentStepUpdate设备:" + me.name + ",步骤9开始运行时间：" + me.runTimeMiddle);
    }
} catch (err) {
...
try {
    if (newValue == 10) {
        ...
        logger.info("currentStepUpdate设备:" + me.name + "步骤9结束运行时间:" + me.runTime_9_11_13);
    }
} catch (err) {
...
try {
    if (newValue == 11) {
        ...
        me.runTimeMiddle = me.totalRunTime;
        logger.info("currentStepUpdate设备:" + me.name + ",步骤10结束运行时间:" + me.runTimeMiddle);
    }
} catch (err) {
...
try {
    if (newValue == 12) {
        ...
        logger.info("currentStepUpdate设备:" + me.name + ",步骤11结束运行时间:" + me.runTime_9_11_13);
    }
} catch (err) {
...
try {
    if (newValue == 13) {
        ...
        me.runTimeMiddle = me.totalRunTime;
        logger.info("currentStepUpdate设备:" + me.name + ",步骤13开始运行时间:" + me.runTimeMiddle);
    }
} catch (err) {
...
try {
    if (newValue == 14) {
        ...
        //工艺总运行时间   13步骤的时间
        me.runTime_9_11_13 = me.runTime_9_11_13 + me.totalRunTime - me.runTimeMiddle;
        logger.info("currentStepUpdate设备:" + me.name + ",步骤13结束运行时间" + me.runTime_9_11_13);
...
//把其他字段  置为0  以防上一循环在下次使用
        ...
        me.pressure_9_11_13_15 = 0;
        me.checkPressure17 = 0;
        me.checkPressure18 = 0;
        me.runTime_9_11_13_15 = 0;
        me.runTime_17_18 = 0;
    }
} catch (err) {
    //把其他字段  置为0  以防上一循环在下次使用
