 ...
 */
public class HttpThingworxCloneTH {
    ...
    public void test() throws IOException {
        ...
        for (int i = startMachineNum; i <= totalMachineNum; i++) {
            ...
            HttpUrl url = new HttpUrl.Builder()
                    ...
                    .host("10.17.3.99")
                    .port(8080)
                    .addPathSegments("Thingworx/Things/TS.ELEC.PepolyMain1001.TH/Services" + "/" + method)
            ...
            Request request = new Request
                    ...
                    .url(url)
                    .post(requestBody)
                    .addHeader("cookie", "JSESSIONID=6E2CE99CCADA488FAB403664FEA42EB9")
