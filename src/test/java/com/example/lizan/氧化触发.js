...
try {
    if (newValue == 10) {
        ...
        logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤9结束时间点管道:" + me.tube + ",氧化时间" + me.checkOxidationTime);
        //BCl3流量
        ...
        //氧气
        me.checkO2_10 = me.o2;
        logger.info("oxidation_currentStepUpdate设备:"+parts[2]+",管道:"+me.tube+",步骤10开始时间的氧气:"+me.checkO2_10);
        //氮气
        me.checkBn2_10 = me.bn2;
        logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤9结束时间点管道:" + me.tube + ",氮气" + me.checkBn2_10);
    }
} catch (err) {
...
try {
    if (newValue == 11) {
        ...
        logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤11结束时间点管道:" + me.tube + ",泵速" + me.checkPumpSpeed10 +
            ",温度" + me.checkInTemp1_10 + ",氮气" + me.checkBn2_11 + ",氧气" + me.checkO2_11 +
...
try {
    if (newValue == 12) {
        ...
        if (me.recipeName == "YH0003") {
            ...
            logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤12结束时间点管道:" + me.tube + ",运行时间:" +  me.totalRunTime);

        }
        logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤12结束时间点管道:" + me.tube + ",泵速" + me.checkPumpSpeed11 +
            ",温度" + me.checkInTemp1_11 + ",氮气" + me.checkBn2_12 + ",氧气" + me.checkO2_12 +
...
try {
    if (newValue == 13) {
        ...
        if (me.recipeName == "YH0002") {
            me.checkOxidationTime = me.totalRunTime - me.checkOxidationTime;
            logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤13结束时间点管道:" + me.tube + ",运行时间:" +  me.totalRunTime);
        }

        logger.info("oxidation_currentStepUpdate设备:" + parts[2] + ",步骤13结束时间点管道:" + me.tube + ",泵速" + me.checkPumpSpeed12 +
            ",温度" + me.checkInTemp1_12 +
...
try {
    ...
    me.checkPumpSpeed11 = 0;
    me.checkPumpSpeed12 = 0;
    logger.error("oxidation_currentStepUpdate大循环结束时间点设备:" + parts[2] + ",大循环结束时间点报错:" + err.message);
}