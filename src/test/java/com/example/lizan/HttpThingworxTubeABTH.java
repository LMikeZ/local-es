 ...
 */
public class HttpThingworxTubeABTH {
    ...
    public void test() throws IOException {
        ...
        int baseNum = 1000;
        // 开始设备编号
        int startMachineNum = 3;
        // 设备总台数
        int totalMachineNum = 17;
        ...
        for (int i = startMachineNum; i <= totalMachineNum; i++) {
            ...
            HttpUrl url = new HttpUrl.Builder()
                    ...
                    .host("10.17.3.99")
                    .port(8080)
                    .addPathSegments("Thingworx/Things/TS.ELEC.DRY1001A.DRY1.TH/Services" + "/" + method)
            ...
            for (int j = 1; j <= 3; j++) {
                ...
                jsonObject.put("machineNo", machineIdStr);
                jsonObject.put("sourceNo", "1001");
                jsonObject.put("descriptionStr", "烘箱" + machineIdStr + "A" + " DRY" + j + "点检");
                jsonObject.put("nameStr", "TS.ELEC.DRY1001A.DRY" + j + ".TH");
                ...
                Request request = new Request
                        ...
                        .url(url)
                        .post(requestBody)
                        .addHeader("cookie", "JSESSIONID=6BCDCC7FD622FF3DF27DA351CEB1CDCC")
            ...
            for (int j = 1; j <= 3; j++) {
                ...
                jsonObject.put("machineNo", machineIdStr);
                jsonObject.put("sourceNo", "1001");
                jsonObject.put("descriptionStr", "烘箱" + machineIdStr + "B" + " DRY" + j + "点检");
                jsonObject.put("nameStr", "TS.ELEC.DRY1001B.DRY" + j + ".TH");
                RequestBody requestBody = RequestBody.create(JSON, jsonObject.toJSONString());
                // 创建请求对象
                Request request = new Request
                        .Builder()
